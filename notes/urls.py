...
urlpatterns = [
    ...
    path('notes/<int:pk>', views.DetailListView.as_view(), name = "notes.detail"),
    ...
    path('notes/show_public_notes', views.ShowPublicNotesListView.as_view(), name = "notes.show_public_notes"),
